...
class Modal extends BaseComponent {
  ...
  _initializeBackDrop() {
    return new Backdrop({
      isVisible: Boolean(this._config.backdrop) && Boolean(!this._config.modalNonInvasive), // 'staticfiles' option will be translated to true, and booleans will keep their value,
